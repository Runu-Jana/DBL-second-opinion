...
const SEO_MAP = {
  ...
  '/ai-features': { title: 'AI-Assisted Report Review', description: 'How DBL International uses AI to help specialists read medical reports faster and deliver quicker, clearer cancer second opinions.' },
  ...
  '/join-network': { title: 'Join Our Network of Oncologists', description: "Are you a qualified oncologist? Join DBL International's expert panel to provide cancer second opinions and reach patients across India and beyond." },
